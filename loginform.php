<?php //this file cannot contain carriage returns as part of the HTML ?><form id="loginForm" method="post" action="/login-check.php"><div class="error"><?php
		...
		?></div><div class="loginRow"><label for="loginemail">Email&nbsp;</label><input name="loginemail" type="email" id="loginemail" /></div><div class="loginRow"><label for="loginpassword">Password&nbsp;</label><input name="loginpassword" type="password" id="loginpassword" /></div><div class="loginRow"><input type="submit" name="Submit" value="Sign In" onfocus="true"/><label for="remember"><input name="remember" type="checkbox" id="remember" value="1"/>Keep me logged in</label></div><div style="height:1em;clear:both;"><span style="float: left;"><a  href="/forgot-password.php">Forget password?</a></span><span style="float:right;"><a href="/signup.php">Sign Up!</a></span></div><input type="hidden" name="login_submitted" value="1" /></form><div class="clear"></div>